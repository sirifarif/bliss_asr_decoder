...
N=10
inv_acwt=12
cmd="utils/run.pl" # "slurm_pony.pl -p short --time 09:59:00 --mem 15G"
rnn_cmd="utils/run.pl" # "slurm_pony.pl -p short --time 09:59:00 --mem 15G -x mlp[08,09]"
...
if [ $stage -le 6 ]; then
  ...
  $rnn_cmd JOB=1:$nj $dir/log/rnnlm_compute_scores.JOB.log \
