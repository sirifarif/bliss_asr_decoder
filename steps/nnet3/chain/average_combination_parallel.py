...
def get_args():
    ...
    parser.add_argument("--trainer.num-chunk-per-minibatch", type=str,
                        ...
                        the format.""")
    parser.add_argument("--trainer.weights", type=str,
                        dest='weights', default='0.6:0.3:0.1',
                        help="""Model averaging weights""")
...
def average_parallel(args, run_opts):
    ...
    logger.info("Doing the averaging to produce .mdl")

    chain_lib.average_models(
        dir=args.dir,
        iter=args.iter,
...
def main():
    ...
    try:
        average_parallel(args, run_opts)
