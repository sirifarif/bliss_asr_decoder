...
def get_args():
    ...
    parser.add_argument("--trainer.do-final-combination", type=int, dest='do_final_combination',
                        default=0,
                        help="Final combination flag")
