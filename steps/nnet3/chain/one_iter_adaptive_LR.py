...
#    logger.info("Arguments for the experiment\n{0}".format(arg_string))
    ...
    if args.email is not None:
        ...
        if args.iter % reporting_iter_interval == 0:
            ...
            subject = ("Update : Expt {dir} : "
                       "Iter {iter}".format(dir=args.dir, iter=args.iter))
            common_lib.send_mail(message, subject, args.email)

    args.num_archives_processed = args.num_archives_processed + current_num_jobs
