...
def get_args():
    ...
    parser.add_argument("--trainer.suffix", type=str, dest='suffix',
                        default="",
                        help="Database suffix")
...
#    logger.info("Arguments for the experiment\n{0}".format(arg_string))
    ...
    print(num_archives)
    if (args.num_jobs_final > args.num_archives_to_process):
    ...
    num_iters = ((args.num_archives_to_process * 2)
    ...
    lrate = common_train_lib.get_learning_rate(args.iter, current_num_jobs,
                                               num_iters,
                                               args.num_archives_processed,
                                               args.num_archives_to_process,
    ...
    percent = args.num_archives_processed * 100.0 / args.num_archives_to_process
    epoch = (args.num_archives_processed * args.num_epochs
             / args.num_archives_to_process)
    shrink_info_str = ''
    ...
    logger.info("Iter: {0}/{1}    "
                ...
                "lr: {5:0.6f}    {6}".format(args.iter, num_iters - 1,
                                             epoch, args.num_epochs,
                                             percent,
                                             lrate, shrink_info_str))
    print num_archives,args.num_archives_processed
    chain_lib.train_one_iteration_parallel(
        dir=args.dir,
        iter=args.iter,
        srand=args.srand,
        egs_dir=egs_dir,
        num_jobs=current_num_jobs,
        num_archives_processed=args.num_archives_processed,
        num_archives=num_archives,
        learning_rate=lrate,
        dropout_edit_string=common_train_lib.get_dropout_edit_string(
            args.dropout_schedule,
            float(args.num_archives_processed) / args.num_archives_to_process,
            args.iter),
