...
export train_cmd="slurm_pony.pl -p short --time 11:59:00 --mem 2G -x mlp12"
export ivector_cmd="slurm_pony.pl -p short --time 11:59:00 --mem 20G -x mlp12"
export align_cmd="slurm_pony.pl -p short --time 11:59:00 --mem 2G -x mlp12"
export decode_cmd="slurm_pony.pl -p short --time 11:59:00 --mem 10G -x mlp12"
export mkgraph_cmd="slurm_pony.pl -p short --time 11:59:00 --mem 8G -x mlp12"
export rnn_cmd="slurm_pony.pl -p short --num-threads 1 --gpu 1 --time 08:59:00 --mem 12G"
export cuda_cmd="slurm_pony.pl -p short --num-threads 1 --time 00:10:00 --mem 4G"
